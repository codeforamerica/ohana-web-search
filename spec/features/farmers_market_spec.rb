feature 'Visitor views the details page of a farmers market' do
  ...
  scenario 'market accepts SNAP and sells cheese' do
    ...
    expect(page).to have_content("Payment methods accepted: Credit SFMNP SNAP WIC")
    expect(page).to have_content("Products sold: Cheese Eggs Flowers Herbs Jams Meat Nursery Plants Poultry Seafood Vegetables")
